...
from training.functions.lambeq_functions import make_lambeq_cost_fn
...
class Evaluation:
    ...
    def evaluate_pennylane_optax_on_test_sett(self, iteration, test_circuits, test_data_labels):
        ...
        with open(test_result_file, "r") as f:
            file = json.load(f)
            file["results"].append({ "step": iteration, "test_accuracy": test_acc, "number_of_test_circuits": len(test_circuits) })
